...
demographic <- data |> 
  select(1 : 11) |> 
  mutate(across(1:11, as.factor))  # converting character data into factor

glimpse(demographic)  #checking data structure


#knowledge

knowledge <- data |>  # selecting knowledge questions from data
  select(12 : 23) 
